...
class UserInfo(models.Model):
    ...
    role = models.IntegerField(verbose_name="角色", choices=((1, "管理员"), (2, "会员"), (3, "用户"), (4, "非法用户")), default=3)
...
class CarmiInfo(models.Model):
    ...
    carmi_buy_status = models.IntegerField(verbose_name="卡密购买状态", choices=((0, "未购买"), (1, "已购买")), default=0)
    carmi_use_status = models.IntegerField(verbose_name="卡密使用状态", choices=((0, "未使用"), (1, "已使用")), default=0)
...
class CarmiBuyLog(models.Model):
    """卡密购买记录"""
    carmi_code = models.ForeignKey(verbose_name="卡密", to="CarmiInfo", on_delete=models.CASCADE)
    buying_user = models.ForeignKey(verbose_name="购买用户", to="UserInfo", on_delete=models.CASCADE)
    buying_time = models.DateTimeField(verbose_name="购买时间", auto_now_add=True)
